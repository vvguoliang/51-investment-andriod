...
//                    klineDatamodel.setTotal(data.optJSONArray(i).optDouble(6));
                    klineDatamodel.setMa5(data.optJSONArray(i).optDouble(5));
                    klineDatamodel.setMa10(data.optJSONArray(i).optDouble(6));
                    klineDatamodel.setMa20(data.optJSONArray(i).optDouble(7));
//                    klineDatamodel.setMa30(data.optJSONArray(i).optDouble(10));
//                    klineDatamodel.setMa60(data.optJSONArray(i).optDouble(11));
                    klineDatamodel.setPreClose(data.optJSONArray(i).optDouble(8));
     ...
     * 初始化基本数据
     */
    public void initCandle(int type) {
        xVal.clear();
        ...
        for (int i = 0; i < getKLineDatas().size(); i++) {
            if (type == 1) {
                ...
                xVal.add(DataTimeUtil.secToday(getKLineDatas().get(i).getDateMills()));
            }
