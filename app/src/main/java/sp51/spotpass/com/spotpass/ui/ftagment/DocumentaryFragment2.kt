 ...
 * ******┗┻┛  ┗┻┛
 */
class DocumentaryFragment2 : BaseFragment() {
    ...
    override fun onResume() {
        super.onResume()
        MobclickAgent.onPageStart("DocumentaryFragment2") //统计页面("MainScreen"为页面名称，可自定义)
    }

    override fun onPause() {
        super.onPause()
        MobclickAgent.onPageEnd("DocumentaryFragment2")
    }
