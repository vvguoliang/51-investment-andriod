...
/**
 * @Time : 2018/5/8 no 12:52
 * @USER : vvguoliang
 * @File : TouchableTabLayout.java
...
class TouchableTabLayout constructor(context: Context,
    ...
    interface TabClickListener {
        fun onTabClicked(selected: Int, fromTouch: Boolean, event: MotionEvent?)
    }
    ...
    init {
        ...
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.TouchableTabLayout_tabPadding, 0)
        mTabPaddingEnd = mTabPaddingBottom
        mTabPaddingTop = mTabPaddingEnd
        mTabPaddingStart = mTabPaddingTop
        mTabPaddingStart = a.getDimensionPixelSize(R.styleable.TouchableTabLayout_tabPaddingStart, mTabPaddingStart)
        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.TouchableTabLayout_tabPaddingTop, mTabPaddingTop)
        mTabPaddingEnd = a.getDimensionPixelSize(R.styleable.TouchableTabLayout_tabPaddingEnd, mTabPaddingEnd)
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.TouchableTabLayout_tabPaddingBottom, mTabPaddingBottom)
        ...
        val ta = context.obtainStyledAttributes(mTabTextAppearance, R.styleable.TouchableTabLayoutTextAppearance)
        try {
        ...
        mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.TouchableTabLayout_tabMinWidth, INVALID_WIDTH)
        mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.TouchableTabLayout_tabMaxWidth, INVALID_WIDTH)
        ...
        val res = resources
        mTabTextMultiLineSize = res.getDimensionPixelSize(R.dimen.commont_dp12).toFloat()
        mScrollableTabMinWidth = res.getDimensionPixelSize(R.dimen.commont_dp10)
    ...
    /**
     * Add a [TouchableTabLayout.OnTabSelectedListener] that will be invoked when tab selection
     * changes.
     *
     *
     *
    ...
    /**
     * Remove the given [TouchableTabLayout.OnTabSelectedListener] that was previously added via
    ...
    /**
     * Remove all previously added [TouchableTabLayout.OnTabSelectedListener]s.
     */
    ...
    /**
     * Create and return a new [TouchableTabLayout.Tab]. You need to manually add this using
    ...
    /**
     * Returns the current mode used by this [TouchableTabLayout].
     *
     * @see .setTabMode
     */
    /**
    ...
    /**
     * The one-stop shop for setting up this [TouchableTabLayout] withLog a [ViewPager].
     *
     *
     *
    ...
    @Deprecated("", ReplaceWith("setPagerAdapter(adapter, false)"))
    ...
    class Tab internal constructor() {
        ...
        internal var mParent: TouchableTabLayout? = null
    ...
    internal inner class TabView(context: Context) : LinearLayout(context) {
        ...
        init {
            ...
            ViewCompat.setPaddingRelative(this, mTabPaddingStart, mTabPaddingTop,
                    mTabPaddingEnd, context.resources.getDimension(R.dimen.commont_dp15).toInt())
        ...
        override fun onTouchEvent(event: MotionEvent): Boolean {
            if (event.action == MotionEvent.ACTION_UP)
                tabClickListener?.onTabClicked(tab?.position ?: 0, true, event)
...
//                }
    ...
    private inner class SlidingTabStrip internal constructor(context: Context) : LinearLayout(context) {
        ...
        override fun draw(canvas: Canvas) {
            super.draw(canvas)
            indicatorRect.set(mIndicatorLeft.toFloat(), (height - mSelectedIndicatorHeight).toFloat(),
     ...
     * not cause a leak.
     */
    class CustomTabLayoutOnPageChangeListener(CustomTabLayout: TouchableTabLayout) : ViewPager.OnPageChangeListener {
        private val mCustomTabLayoutRef: WeakReference<TouchableTabLayout> = WeakReference(CustomTabLayout)
        private var mPreviousScrollState: Int = 0
        private var mScrollState: Int = 0
        private val tabClickListener = CustomTabLayout.tabClickListener
        private var touchableTabLayout = CustomTabLayout.mPagerAdapter

        override fun onPageScrollStateChanged(state: Int) {
            mPreviousScrollState = mScrollState
            mScrollState = state
            touchableTabLayout?.notifyDataSetChanged()
        }
        ...
        override fun onPageScrolled(position: Int, positionOffset: Float,
            ...
            if (customTabLayout != null) {
                ...
                // being dragged
                val updateText = mScrollState != ViewPager.SCROLL_STATE_SETTLING || mPreviousScrollState == ViewPager.SCROLL_STATE_DRAGGING
                // Update the indicator if we're not settling after being idle. This is caused
                // from a setCurrentItem() call and will be handled by an animation from
                // onPageSelected() instead.
                val updateIndicator = !(mScrollState == ViewPager.SCROLL_STATE_SETTLING && mPreviousScrollState == ViewPager.SCROLL_STATE_IDLE)
    ...
    companion object {
        ...
        /**
         * Gravity used to fill the [TouchableTabLayout] as much as possible. This option only takes effect
    ...
    private val LINEAR_INTERPOLATOR: LinearInterpolator = LinearInterpolator()
    private val FAST_OUT_SLOW_IN_INTERPOLATOR: FastOutSlowInInterpolator = FastOutSlowInInterpolator()
    private val FAST_OUT_LINEAR_IN_INTERPOLATOR: FastOutLinearInInterpolator = FastOutLinearInInterpolator()
