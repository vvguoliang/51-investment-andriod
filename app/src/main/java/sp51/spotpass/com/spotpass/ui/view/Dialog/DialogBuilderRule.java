 ...
 * ******┗┻┛  ┗┻┛
 */
public class DialogBuilderRule {
    ...
    private boolean messboolean = false;
    ...
    public DialogBuilderRule(Context context) {
        this(context, R.style.CustomDialog);
    }

    @SuppressLint("InflateParams")
    public DialogBuilderRule(Context context, int themeResId) {
    ...
    //自定义layout用这个
    public DialogBuilderRule(Context context, int themeResId, View layout) {
    ...
    //能否返回键取消
    public DialogBuilderRule setCancelable(Boolean cancelable) {
        this.cancelable = cancelable;
        return this;
    }

    public DialogBuilderRule title(CharSequence title) {
        this.title = title;
        return this;
    }

    public DialogBuilderRule message(CharSequence message) {
        this.message = message;
        return this;
    }

    //取消
    public DialogBuilderRule cancelText(CharSequence str) {
        this.cancelText = str;
        return this;
    }

    //确定按钮文本 确定
    public DialogBuilderRule sureText(CharSequence str) {
        this.sureText = str;
        return this;
    }

    public DialogBuilderRule setSureOnClickListener(View.OnClickListener listener) {
        this.sureClickListener = listener;
        return this;
    }

    public DialogBuilderRule setCancelOnClickListener(View.OnClickListener listener) {
        this.cancelClickListener = listener;
        return this;
    }

    public DialogBuilderRule messageClickLkistener(boolean messboolean) {
        this.messboolean = messboolean;
        return this;
    }
    ...
    public Dialog build() {
        ...
        if (messboolean) {
            textView.setOnClickListener(view -> {
                ...
                intent.putExtra("url", GetAssetsFiles.getString(context, "挂单建仓限制条款.htm"));
