 ...
 * ******┗┻┛  ┗┻┛
 */
class DocumentaryFragment1 : BaseFragment() {
    ...
    override fun onResume() {
        super.onResume()
        MobclickAgent.onPageStart("DocumentaryFragment1") //统计页面("MainScreen"为页面名称，可自定义)
    }

    override fun onPause() {
        super.onPause()
        MobclickAgent.onPageEnd("DocumentaryFragment1")
    }
