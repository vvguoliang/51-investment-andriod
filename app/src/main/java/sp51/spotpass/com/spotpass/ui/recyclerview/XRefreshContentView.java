...
import sp51.spotpass.com.spotpass.ui.recyclerview.recyclerview.XSpanSizeLookup;
import sp51.spotpass.com.spotpass.ui.utils.LogUtils;
import sp51.spotpass.com.spotpass.ui.view.XWebView;
...
public class XRefreshContentView implements OnScrollListener, OnTopRefreshTime, OnBottomLoadMoreTime {
    ...
    public void onRecyclerViewScrolled(RecyclerView recyclerView, BaseRecyclerAdapter adapter, int dx, int dy, boolean force) {
        ...
        LogUtils.INSTANCE.d("test pre onScrolled mIsLoadingMore=" + mIsLoadingMore);
    ...
    private void setRecyclerViewScrollListener() {
        ...
        if (recyclerView.getAdapter() != null) {
            if (recyclerView.getAdapter() instanceof BaseRecyclerAdapter) {
                ...
                LogUtils.INSTANCE.w(RECYCLERVIEW_ADAPTER_WARIN);
            }
        }
