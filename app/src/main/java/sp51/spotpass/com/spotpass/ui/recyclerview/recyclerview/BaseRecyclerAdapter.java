package sp51.spotpass.com.spotpass.ui.recyclerview.recyclerview;
...
import sp51.spotpass.com.spotpass.ui.recyclerview.Utils;
...
public abstract class BaseRecyclerAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public VH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPES.FOOTER) {
            ...
            return getViewHolder(customLoadMoreView);
    ...
    public void addFooterView() {
        LogUtils.INSTANCE.d("test addFooterView");
        if (removeFooter) {
    ...
    public void removeFooterView() {
        LogUtils.INSTANCE.d("test removeFooterView");
        if (!removeFooter) {
