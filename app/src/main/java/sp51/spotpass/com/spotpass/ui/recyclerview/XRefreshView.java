package sp51.spotpass.com.spotpass.ui.recyclerview;
...
import sp51.spotpass.com.spotpass.ui.recyclerview.callback.IFooterCallBack;
import sp51.spotpass.com.spotpass.ui.recyclerview.callback.IHeaderCallBack;
import sp51.spotpass.com.spotpass.ui.recyclerview.listener.OnBottomLoadMoreTime;
import sp51.spotpass.com.spotpass.ui.recyclerview.listener.OnTopRefreshTime;
...
//        if(mHolder.mOffsetY!=0)return;
        LogUtils.INSTANCE.d("onLayout mHolder.mOffsetY=" + mHolder.mOffsetY);
        int childCount = getChildCount();
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                LogUtils.INSTANCE.d("isTop=" + mContentView.isTop() + ";isBottom=" + mContentView.isBottom());
    ...
    private void sendCancelEvent() {
        if (!mHasSendCancelEvent) {
            LogUtils.INSTANCE.d("sendCancelEvent");
            setRefreshTime();
    ...
    private void sendDownEvent() {
        if (!mHasSendDownEvent) {
            LogUtils.INSTANCE.d("sendDownEvent");
            mHasSendCancelEvent = false;
    ...
    private void resetHeaderHeight() {
        ...
        LogUtils.INSTANCE.d("resetHeaderHeight offsetY=" + offsetY);
    }
...
//            headerMovePercent = headerMovePercent > 1 ? 1 : headerMovePercent;
    ...
    public void stopRefresh(boolean success) {
        LogUtils.INSTANCE.d("stopRefresh mPullRefreshing=" + mPullRefreshing);
        ...
        if (needAddFooterView()) {
            if (mPullLoading) {
                ...
                if (mPinnedTime >= 1000) {// 在加载更多完成以后，只有mPinnedTime大于1s才生效，不然效果不好
                    postDelayed(() -> endLoadMore(hideFooter, scrollBackDuration), mPinnedTime);
                } else {
    ...
    private ScrollRunner mRunnable = new ScrollRunner() {
        ...
        public void run() {
            if (mScroller.computeScrollOffset()) {
                ...
                LogUtils.INSTANCE.d("currentY=" + currentY + ";mHolder.mOffsetY=" + mHolder.mOffsetY);
