...
public class LoginDialogBuilder {
    ...
    public LoginDialogBuilder(Context context, int themeResId) {
    ...
    //自定义layout用这个
    public LoginDialogBuilder(Context context, int themeResId, View layout) {
    ...
    //能否返回键取消
    public LoginDialogBuilder setCancelable(Boolean cancelable) {
        this.cancelable = cancelable;
        return this;
    }

    public LoginDialogBuilder title(CharSequence title) {
        this.title = title;
        return this;
    }

    public LoginDialogBuilder message(CharSequence message) {
        this.message = message;
        return this;
    }

    public LoginDialogBuilder messageeditext_text(boolean editext_text) {
        this.editext_text = editext_text;
        return this;
    }

    //取消
    public LoginDialogBuilder cancelText(CharSequence str) {
        this.cancelText = str;
        return this;
    }

    //确定按钮文本 确定
    public LoginDialogBuilder sureText(CharSequence str) {
        this.sureText = str;
        return this;
    }

    public LoginDialogBuilder setSureOnClickListener(View.OnClickListener listener) {
        this.sureClickListener = listener;
        return this;
    }

    public LoginDialogBuilder setCancelOnClickListener(View.OnClickListener listener) {
        this.cancelClickListener = listener;
        return this;
    }

    public LoginDialogBuilder setTextWatcherr(TextWatcher textWatcher) {
