...
import sp51.spotpass.com.spotpass.ui.viwepage.holder.MZHolderCreator;
import sp51.spotpass.com.spotpass.ui.viwepage.holder.MZViewHolder;
import sp51.spotpass.com.spotpass.ui.viwepage.transformer.CoverModeTransformer;
import sp51.spotpass.com.spotpass.ui.viwepage.transformer.ScaleYTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private boolean mIsRunnalb = false;//run是否在执行中
...
//        pause();
        ...
        mAdapter.MZPager(mDatas, mzHolderCreator, mIsCanLoop);
    ...
    public static class MZPagerAdapter<T> extends PagerAdapter {
        ...
        void MZPager(List<T> datas, MZHolderCreator MZHolderCreator, boolean canLoop) {
            if (mDatas == null) {
