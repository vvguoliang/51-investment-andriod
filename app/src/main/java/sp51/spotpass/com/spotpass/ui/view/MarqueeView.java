...
public class MarqueeView extends ViewFlipper {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        @SuppressLint("CustomViewStyleable") TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.MarqueeViewStyle, defStyleAttr, 0);
    ...
    private View createView(int position) {
        ...
        @SuppressLint("InflateParams") View view = LayoutInflater.from(mContext).inflate(R.layout.view_marquee, null);
        ImageView ivMarquee = view.findViewById(R.id.ivMarquee);
        ImageView marquee_image = view.findViewById(R.id.marquee_image);
        ...
        TextView marquee_text1 = view.findViewById(R.id.marquee_text1);

//        SpannableStringBuilder builder = new SpannableStringBuilder(marquee.getContext());
//        ForegroundColorSpan redSpan = new ForegroundColorSpan(Color.RED);
//        builder.setSpan(redSpan, Objects.requireNonNull(marquee.getContext()).length() - 9, marquee.getContext().length() - 4, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        marquee_text.setText(Html.fromHtml("盈利"));
        marquee_text1.setText(marquee.getContext());
        if (isImage) {
            ...
            ivMarquee.setVisibility(View.GONE);
        }
